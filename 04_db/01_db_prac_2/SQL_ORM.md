...
```python
# orm print(User.objects.all().query)
```
...
2. user 레코드 생성
   ...
   ```python
   # orm  User.objects.create(first_name='길동', last_name='홍',age=100, country='제주특별자치도', phone='010-1234-1234', balance=1000,)
   ```
...
5. 해당 user 레코드 삭제
   ...
   ```python
   # orm User.objects.get(pk=101).delete()
   ```
